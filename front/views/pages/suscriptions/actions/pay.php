	...
	if(isset($routesArray[3])) {
		...
		if($security[1] == $_SESSION["user"]->token_usuario) {
			...
			if($response->response->status == 200) {
                ...
                if($suscripcion->estado_suscripcion == 'pagado') {

                    echo '<script>
                            fncFormatInputs();
                            matPreloader("off");
                            fncSweetAlert("close", "", "");
                            fncSweetAlert("error", "El pago ya se ha realizado", "/suscriptions");
                        </script>';
    ...
    <form method="post" class="needs-validation" novalidate enctype="multipart/form-data" autocomplete="off">
        ...
        <div class="card-body">
            ...
            <?php
                ...
                $create -> edit($suscripcion->id_suscripcion);
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="form-floating mb-3 mt-2">
                        <select name="pay-metodo" id="pay-metodo" class="form-select" required>
