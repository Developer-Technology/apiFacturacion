...
<div class="content__header content__boxed overlapping">
    <div class="content__wrap">
            ...
            <ol class="breadcrumb mb-0">
                ...
                <?php if (isset($routesArray[2])): ?>
                    ...
                    <?php if ($routesArray[2] == "new" || $routesArray[2] == "edit"): ?>
                        ...
                        <li class="breadcrumb-item"><a href="/despatch-remitent">Remitente</a></li>
        ...
        <h1 class="page-title mb-0 mt-2">Remitente</h1>
        <p class="lead">En esta sección podrás realizar el envío de guías de remisón remitente.</p>
