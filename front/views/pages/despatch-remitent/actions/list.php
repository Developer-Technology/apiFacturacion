...
<div class="card">
    <div class="card-header mt-4 mb-3">
        <div class="row">
            ...
            <div class="col-md-6 d-flex gap-1 align-items-center justify-content-md-end mb-3">
                ...
                <a href="/despatch-remitent/new" class="btn btn-primary hstack gap-2 align-self-center">
    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
            ...
            <table id="adminsTable" class="table table-bordered table-striped table-hover tableDtpub">
